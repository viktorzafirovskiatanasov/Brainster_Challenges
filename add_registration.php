...
if($_SERVER['REQUEST_METHOD'] === 'POST')
{
     ...
     $DBregistrations = RegistrationSelect::checkCassisNumber($chassis_number);
     if(empty($DBregistrations)){
        $insertResult = RegistrationSelect::insertRegistration($model, $chassis_number, $vehicle_type, $production_year, $registration, $fuel_type, $registrated_till);
