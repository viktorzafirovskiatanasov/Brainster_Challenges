                    ...
                    <div class="w-full lg:max-w-full flex bg-white p-8 rounded-lg">
                        <div class="flex-none">
                            <?php if($discussion->image): ?>
                                <img src="<?php echo e(Storage::url('app/public/images' . $discussion->image)); ?>" alt="Image"
...
<?php /**PATH C:\Users\User\Desktop\challenge\resources\views/components/home-view.blade.php ENDPATH**/ ?>