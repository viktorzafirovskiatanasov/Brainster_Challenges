            ...
            <div class="col-8 offset-2 align-center">
                <?php $__currentLoopData = $discussions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $discussion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if(Auth::user()->isAdmin() || Auth::user()->id === $discussion->user_id): ?>
                        <div
                            class="w-full lg:max-w-full flex bg-white p-8 my-8 rounded-lg <?php echo e($discussion->status === 'denied' ? 'bg-red-200' : 'bg-yellow-100'); ?>">
                            <div class="flex-none">
...
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Desktop\challenge\resources\views/challenge/approve-page.blade.php ENDPATH**/ ?>